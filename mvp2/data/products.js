...
var productTypes = ['fixedPrice', 'perDuration', 'perMonthlyUsage'];
...
[
    ...
    {price:1,	category:"שיחות בינלאומיות",	name:"שוויץ -סלולארי מבצע תקשורת", type:"perDuration", columns:[2, 1]},
    ...
    {price:1,	category:"שיחות בינלאומיות",	name:"בריטניה -סלולארי חבילת בנק", type:"perDuration", columns:[2, 1]},
    {price:1,	category:"שיחות בינלאומיות",	name:"רוסיה מבצע תקשורת" ,        type:"perDuration", columns:[2, 1]},
    {price:1,	category:"שיחות בינלאומיות",	name:"רוסיה -סלולארי מבצע תקשורת", type:"perDuration", columns:[2, 1]},
    ...
    {price:1,	category:"שיחות בינלאומיות",	name:"דרום אפריקה -סלולארי מבצע תקשורת", type:"perDuration", columns:[2, 1]},
